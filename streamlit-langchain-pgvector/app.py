...
def upload():
    if uploaded_file is None:
        ...
        embeddings = OpenAIEmbeddings(model="text-embedding-ada-002", openai_api_key=api_key, openai_api_base=api_base, http_client = http_client)
...
#initiate model
llm = ChatOpenAI(model_name="gpt-3.5-turbo", openai_api_key=api_key, openai_api_base=api_base, http_client = http_client, streaming=True)
